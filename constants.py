...
CHAMPIOSHIP_TOURNAMENTS_STATISTIC_URL = 'https://virtualsoccer.ru/statistics.php?act=29&sort=5&continent=0&country=80&division=0&pl_min_season=66&plus_minus_type=3'
