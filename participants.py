...
PARTICIPANTS = Participants([
    ...
    Team(18588, 'Хесус-Менендес', TeamSchool.RAIN, TeamDivision.D2),
    Team(8985, 'Азукарерос (Санта-Клара)', TeamSchool.RAIN, TeamDivision.D2),
    Team(21374, 'Санта-Клара', TeamSchool.RAIN, TeamDivision.D3A),
    ...
    Team(8155, 'Лас-Тунас', TeamSchool.RAIN, TeamDivision.D2),
...
PLAYERS_PARTICIPANTS = Participants([
    ...
    Player(6596175, 'Жорже Поганьес', 10927),
])
