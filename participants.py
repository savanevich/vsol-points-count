...
PARTICIPANTS = Participants([
    ...
    Team(8140, 'Санкти-Спиритус', TeamSchool.RAIN, TeamDivision.D1),
    ...
    Team(18639, 'Баракоа', TeamSchool.RAIN, TeamDivision.D1),
...
PLAYERS_PARTICIPANTS = Participants([
    ...
    Player(7038765, 'Фернандо Кетасес', 8140),
    Player(6951429, 'Рой Педраса', 8985),
    Player(6996693, 'Карел Перес', 8967),
    Player(9409844, 'Рейнальдо Баро', 8985),
    Player(9412299, 'Диосвелис Гуэрра', 18590),
    Player(9412311, 'Эдвард Гриньян', 18639),
    Player(6953207, 'Аристидес Себранго', 18588),
])
...
STATISTIC_CORRECTIONS = {
    "cubanas": {
        ...
        "Санкти-Спиритус": 0,
        "Лас-Тунас": 47,
        "Артемиса (Сан-Кристобаль)": 60,
        "Испано Америка (Гавана)": 2,
        "Пинар-дель-Рио": 49,
        "Сантьяго-де-Куба": 27,
        "Ховельянос": 0,
        "Баракоа": 40,
        "Казино Эспаньол (Гавана)": 13,
        "Азукарерос (Санта-Клара)": 2,
    },
    "olivares": {
        6846600: 0,
        6842986: 0,
